...
export default function Header() {
  ...
  return (
    <div className="flex dark:bg-stone-800 dark:text-white sm:justify-between items-center flex-wrap gap-2 justify-center sm:ps-5 sm:pe-16 py-2 bg-yellow-400 w-full">
